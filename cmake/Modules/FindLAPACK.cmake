...
if(LAPACK95 IN_LIST LAPACK_FIND_COMPONENTS)
  find_path(LAPACK95_INCLUDE_DIR
    NAMES lapack95.mod
    HINTS ${MKLROOT}
    PATH_SUFFIXES include/intel64/${_mkl_bitflag}lp64
    NO_DEFAULT_PATH
  )
...
set(LAPACK_LIBRARY ${LAPACK_LIBRARY} PARENT_SCOPE)
set(LAPACK_INCLUDE_DIR ${LAPACK_INCLUDE_DIR} ${LAPACK_MODULE_DIR} PARENT_SCOPE)
...
if(MKL IN_LIST LAPACK_FIND_COMPONENTS)
  ...
  set(_mkl_libs)
  if(LAPACK95 IN_LIST LAPACK_FIND_COMPONENTS)
    find_mkl_libs(mkl_lapack95_${_mkl_bitflag}lp64 mkl_blas95_${_mkl_bitflag}lp64)
    if(LAPACK_LIBRARY)
